...
# ─── Permissions ──────────────────────────────────────────────────────────────
has_permission = {
    "Sales Form":    "channel_management.permissions.sales_form.has_permission",
    ...
    "Customer":      "channel_management.permissions.customer.has_permission",
}

# ─── Doc Events ───────────────────────────────────────────────────────────────
doc_events = {
    "Sales Form": {
        "on_change": "channel_management.channel_management.doctype.sales_form.sales_form.handle_workflow_change",
    }
}
